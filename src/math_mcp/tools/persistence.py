...
async def save_calculation(
    ...
    result: Annotated[float, Field(description="Numeric result of evaluating the expression, e.g., 78.54")],
...
async def load_variable(
    name: Annotated[str, Field(description="Name of the variable to load from workspace, e.g., 'circle_area'")], ctx: SkipValidation[Context | None] = None
) -> LoadVariableResult:
